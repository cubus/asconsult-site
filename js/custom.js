(function ($, window, document, undefined) {
    ...
    var pluginName = "Camaro",
        defaults = {
            ...
            errorText: 'Introduceți o adresă de email validă', // text, if email is invalid
    ...
    Plugin.prototype = {
        ...
        contactMap: function() {
            var cmyLatlng = new google.maps.LatLng(45.777315, 24.155400);
            var cmapOptions = {
                zoom: 16,
                scrollwheel: false,
    ...
    $('#main-nav a').click(function(e){
        ...
        var that = $(this),
            hash = that.attr('href'),
            block = $(hash);
        var blockTop = block.offset().top - 180;
        $('body, html').animate({scrollTop : blockTop}, magicNumber*10, function(){
